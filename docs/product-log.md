...
- A busca passou a ocultar resultados/lista até que o texto digitado tenha pelo menos 3 letras e aguarde cerca de 2s para a busca nativa filtrar. Motivação: feedback de amiga apontou que ver recentes antes de uma intenção específica pode indicar mensagem nova e gerar curiosidade; o delay evita flash da lista não filtrada ao digitar/colar rápido.
...
- Validar em uso real se o bloqueio de resultados antes de 3 letras + delay de filtragem cobre todos os estados da busca nativa e não esconde controles úteis do WhatsApp.
