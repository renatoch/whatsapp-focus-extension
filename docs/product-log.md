...
- **[Em validação] Suspender navegação focada sob modais e visualizadores nativos**
  ...
  - O observer DOM existente recalcula a visibilidade na abertura/fechamento. Apenas o shelf de conversa focada é suspenso; overlay inicial e dados em memória não mudam. Testes cobrem modal, media viewer, restauração sem mutar filhos, superfícies ocultas/da extensão e integração com o observer. Validação manual pendente em editor, imagem e vídeo após recarregar extensão/aba.
