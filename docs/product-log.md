...
- **[Diagnóstico em andamento] Captura intermitente dos recentes no modo completo**
  ...
  - Navigator prefere reduzir o vai e volta e ofereceu acesso ao navegador. Ainda não há conexão de depuração configurada. Caso seja adotada, usar acesso local/perfil de teste e inspeção estrutural, sem exportar mensagens/nomes, enviar mensagens ou alterar o perfil principal. A oferta não autoriza expor uma porta à rede nem copiar o perfil real.
